...
- Basic local playback through generated WAV previews and click-to-seek against imported recordings.
- Event review table.
- Settings panels.
...
- Calling Rust core.
- Audio inspection, waveform envelope, and preview WAV commands.
